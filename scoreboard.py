...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        ...
        self.font = pygame.font.Font("font/ARCADE_I.TTF", 20)


        #prep for initial score img
        self.prep_score()
    ...
    def prep_high_score(self):
        ...
        # center high score @ the top of the screen
    ...
    def check_high_score(self):
        # Check to see if there's any new HS
